...
class quizFamily_VC: UIViewController {
    var player:AVAudioPlayer?  //ประกาศเพื่อเล่นเสียงประกอบแต่ละคำถาม
    var countDown = Timer()
    var time = 3
    ...
    func loadQuestions() -> Void {
        let question1 = Question(
            ...
            imgQuestion: "bro.png",
            answers: [
                Answer(answer: "姐姐 jiějie", isRight: false),
                Answer(answer: "弟弟 dìdi", isRight: true),
                Answer(answer: "妹妹 mèimei", isRight: false),
                Answer(answer: "妈妈 māma", isRight: false)]
        )
        ...
        let question2 = Question(
            question: "นี่คือใคร?",
            soundQuestion: "",
            imgQuestion: "bigbro.png",
            answers: [
                Answer(answer: "妈妈 māma", isRight: false),
                Answer(answer: "姐姐 jiějie", isRight: false),
                Answer(answer: "哥哥 gēge", isRight: true),
                Answer(answer: "妹妹 mèimei", isRight: false)]
        )
        ...
        let question3 = Question(
            question: "นี่คือใคร?",
            soundQuestion: "",
            imgQuestion: "mommy.png",
            answers: [
                Answer(answer: "哥哥 gēge", isRight: false),
                Answer(answer: "弟弟 dìdi", isRight: false),
                Answer(answer: "爸爸 bàba", isRight: false),
                Answer(answer: "妈妈 māma", isRight: true)]
        )
        
        let question4 = Question(
            question: "นี่คือใคร?",
            soundQuestion: "",
            imgQuestion: "bigsis.png",
            answers: [
                Answer(answer: "姐姐 jiějie", isRight: true),
                Answer(answer: "爸爸 bàba", isRight: false),
                Answer(answer: "弟弟 dìdi", isRight: false),
                Answer(answer: "哥哥 gēge", isRight: false)
            ]
        ...
        let question5 = Question(
            question: "นี่คือใคร?",
            soundQuestion: "",
            imgQuestion: "daddy.png",
            answers: [
                Answer(answer: "妹妹 mèimei", isRight: false),
                Answer(answer: "爸爸 bàba", isRight: true),
                Answer(answer: "姐姐 jiějie", isRight: false),
                Answer(answer: "妈妈 māma", isRight: false)
            ]
