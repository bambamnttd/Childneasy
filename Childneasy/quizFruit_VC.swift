...
//  Childneasy
//
//  Created by MacBookPro on 4/12/18.
...
class quizFruit_VC: UIViewController {
    ...
    func loadQuestions() -> Void {
        let question1 = Question(
            question: "ผลไม้นี้เรียกว่าอะไร?",
            soundQuestion: "",
            imgQuestion: "apple.png",
            answers: [
                Answer(answer: "橘子 júzi", isRight: false),
                Answer(answer: "苹果 píngguǒ", isRight: true),
                Answer(answer: "葡萄 pútao", isRight: false),
                Answer(answer: "西瓜 xīgua", isRight: false)]
        )
        ...
        let question2 = Question(
            question: "ผลไม้นี้เรียกว่าอะไร?",
            soundQuestion: "",
            imgQuestion: "grape.png",
            answers: [
                Answer(answer: "西瓜 xīgua", isRight: false),
                Answer(answer: "草莓 cǎoméi", isRight: false),
                Answer(answer: "葡萄 pútao", isRight: true),
                Answer(answer: "苹果 píngguǒ", isRight: false)]
        )
        
        let question3 = Question(
            question: "ผลไม้นี้เรียกว่าอะไร?",
            soundQuestion: "",
            imgQuestion: "orange.png",
            answers: [
                Answer(answer: "苹果 píngguǒ", isRight: false),
                Answer(answer: "葡萄 pútao", isRight: false),
                Answer(answer: "草莓 cǎoméi", isRight: false),
                Answer(answer: "橘子 júzi", isRight: true)]
        )
        
        let question4 = Question(
            question: "ผลไม้นี้เรียกว่าอะไร?",
            soundQuestion: "",
            imgQuestion: "straw.png",
            answers: [
                Answer(answer: "橘子 júzi", isRight: false),
                Answer(answer: "西瓜 xīgua", isRight: false),
                Answer(answer: "草莓 cǎoméi", isRight: true),
                Answer(answer: "葡萄 pútao", isRight: false)
            ]
        )
        ...
        let question5 = Question(
            question: "ผลไม้นี้เรียกว่าอะไร?",
            soundQuestion: "",
            imgQuestion: "watermelon.png",
            answers: [
                Answer(answer: "葡萄 pútao", isRight: false),
                Answer(answer: "西瓜 xīgua", isRight: true),
                Answer(answer: "苹果 píngguǒ", isRight: false),
                Answer(answer: "草莓 cǎoméi", isRight: false)
            ]
        )
